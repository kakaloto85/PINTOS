...
//   size_t pos_sectors = bytes_to_sectors(pos);
//   struct inode_disk disk_inode = inode->data;
//   if (pos==0)
//       return (block_sector_t) disk_inode.direct_table[0];
//   else if (pos_sectors <= DIRECT_SEC_BOUNDARY)
//     return (block_sector_t) disk_inode.direct_table[pos_sectors-1];
...
//     return  (block_sector_t) indirect[pos_sectors -DIRECT_SEC_BOUNDARY-1];
...
//       int index = (pos_sectors-INDIRECT_SEC_BOUNDARY-1)/128;
